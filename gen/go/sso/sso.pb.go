...
type LoginRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Email         string                 `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`
	Passwor       string                 `protobuf:"bytes,2,opt,name=passwor,proto3" json:"passwor,omitempty"`
	AppId         int64                  `protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` // с херал ли тут int32 и зачем это вообще надо
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *LoginRequest) GetPasswor() string {
	if x != nil {
		return x.Passwor
	}
	return ""
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\apasswor\x18\x02 \x01(\tR\apasswor\x12\x15\n" +
	...
	"\aIsAdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsAdminResponseB(Z&calculator/services/pkg/gen/go/sso;ssob\x06proto3"
